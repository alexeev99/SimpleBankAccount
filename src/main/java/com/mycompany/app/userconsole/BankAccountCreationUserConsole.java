...
public class BankAccountCreationUserConsole {
  ...
  public static CustomerUserConsoleInput readCustomer() {
    CustomerAddressUserConsoleInput address = BankAccountCreationUserConsole.readCustomerAddress();
    String firstName = BankAccountCreationUserConsole.readCustomerFirstName();
    String lastName = BankAccountCreationUserConsole.readCustomerLastName();
    String cityOfBirth = BankAccountCreationUserConsole.readCustomerCityOfBirth();
    String birthDate = BankAccountCreationUserConsole.readCustomerBirthDate();
    String taxId = BankAccountCreationUserConsole.readCustomerTaxId();
    return new CustomerUserConsoleInput(
        firstName, lastName, cityOfBirth, birthDate, taxId, address);
  }
  ...
  public static CustomerAddressUserConsoleInput readCustomerAddress() {
    ...
    String postalCode = BankAccountCreationUserConsole.readCustomerAddressPostalCode();
    String streetNumber = BankAccountCreationUserConsole.readCustomerAddressStreetNumber();
    String streetName = BankAccountCreationUserConsole.readCustomerAddressStreetName();
    return new CustomerAddressUserConsoleInput(city, postalCode, streetNumber, streetName);
  }
